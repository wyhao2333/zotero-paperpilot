...
First public release of PaperPilot for Zotero 10.
...
- **Markdown & LaTeX Math Rendering**: KaTeX MathML rendering in chat view and native math node formatting in Zotero Note export.
- **Zotero Note Export**: One-click session export to Zotero rich-text notes with single-schema compliance.
- **Multi-Provider AI Client**: Built-in presets for Zhipu GLM, DeepSeek, OpenAI, Moonshot, Qwen, SiliconFlow, Ollama, and OpenAI-compatible custom endpoints.
- **Synchronized Configuration**: Bi-directional preference synchronization between Zotero settings and sidebar panel.

### Notes

- Tested on Zotero 10 only. Other Zotero versions have not been verified.
- Third-party translation and AI API availability, latency, and model outputs are subject to their respective service providers.
