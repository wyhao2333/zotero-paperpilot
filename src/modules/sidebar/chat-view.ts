...
import { MarkdownMathRenderer, HTML_NS } from "../rendering/markdown-math";
...
`;
  ...
  static renderMarkdownContent(md: string): string {
    return MarkdownMathRenderer.renderForSidebarMarkup(md);
  }

  static escape(str: string): string {
    return MarkdownMathRenderer.escapeHtml(str);
  }
